...
<template>
  <section class="bg-white px-16 py-12">
    ...
    <!-- 🔹 Inner Card -->
    <div class="relative overflow-hidden rounded-2xl bg-[#EEEEEE] border border-gray-200 shadow-sm px-12 py-14 min-h-[420px]">
      ...
      <div class="relative z-20 max-w-xl">
        ...
        <!-- 🔍 Search Bar -->
        <div class="mt-8 flex items-center bg-white rounded-full p-2 w-full max-w-md shadow-sm">
